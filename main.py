...
def score_moeda(df):
    ...
    volume_ratio = round(volume_atual / volume_antigo, 2) if volume_antigo > 0 else 0
    ...
    for symbol in moedas:
        try:
            ...
            if resultado["score"] >= 75:
                ...
                par = symbol.replace("USDT", "/USDT")
                link = f"https://www.binance.com/en/trade/{symbol.replace("USDT","_USDT")}"
...
🔥 Volume: {resultado['volume_ratio']}x acima da média\n\n📊 Tendência: ALTA
...
if __name__ == "__main__":
    ...
    while True:
        try:
            ...
            print("Nova análise em 15 minutos")
